...
sql.execute """
             |IF OBJECT_ID('[000028].sampleData', 'U') IS NOT NULL
             |DROP TABLE [000028].sampleData;
             |
             |CREATE TABLE [000028].sampleData ( [Col1] [nvarchar](100) ,[Col2] [nvarchar](100) ,[Col3] [nvarchar](100)
...
println "Successfully Added ${sql.rows('SELECT * FROM [000028].sampleData').size()} Rows"